...
const Login = () => {
  ...
  async function handleSubmit(e) {
    ...
    if (success) window.location.href = '/home/dashboard';
  }
    ...
    <>
      <div className='w-full flex justify-center bg-bodyBg'>
        <div className='max-[662px]:px-10 container flex justify-between items-center py-5 transition-all duration-300'>
          <h1 className='font-bold text-[20px] uppercase text-secondaryShade'>
            Dashboard
          </h1>
      ...
      <div className='h-[88vh] w-full flex justify-center items-center flex-col'>
        <form
          className='min-w-[452px] max-[450px]:min-w-fit shadow-[0px_3px_25px_rgba(0,0,0,0.1)] rounded-md p-10'
        ...
        >
          <div>
            ...
            <p className='text-sm text-lightGray pb-3 pt-2'>
          ...
          <div className='flex justify-between items-center mt-3 pb-5 px-1 '>
            ...
            <p className='cursor-pointer text-secondary hover:underline'>
              Forgot Password?
            </p>
          </div>

          <ButtonTypeSubmitNew type='submit' btn='Login' />
        </form>
      </div>
